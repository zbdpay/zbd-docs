...
To ensure the security of your game integration with the [ZBD API](/payments/api), it is _crucial_ to safeguard your [ZBD API Key](/get-started/api-keys) and avoid exposing it within any client-side code. 
...
This demo showcases a working implementation of [ZBD Login](/earn/oauth2) (OAuth2) using [Beamable](https://beamable.com/?referral=zbd) Microservices on an Android device, enabling you to quickly achieve secure login to your game. 
...
This scene shows how you can integrate [ZBD Login](/earn/oauth2) with an Android build.
...
Add your [Client ID](/earn/oauth2/integration) from the [ZBD Developer Dashboard](https://dashboard.zebedee.io/) and add it to the `LoginController` in the ZBD Login demo scene.
