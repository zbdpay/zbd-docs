...
We recommend using **Log in with ZBD** for integrating the ZBD API:
...
To learn how to Send to Gamertag, check our docs [here](https://docs.zbdpay.com/api-reference/zbd-gamertag/send).
