...
<CardGroup cols={2}>
  <Card title="Get User ID" icon="fingerprint" href="/earn/api/gamertags/retrieve-userid">
    Convert gamertag to permanent ID
  </Card>
  <Card title="Get Gamertag" icon="at" href="/earn/api/gamertags/retrieve-from-userid">
    Convert ID back to current gamertag
  </Card>
  <Card title="Create Charge" icon="receipt" href="/earn/api/gamertags/create-charge">
...
<Card title="View Full API Reference" icon="book" href="/earn/api/gamertags/send">
