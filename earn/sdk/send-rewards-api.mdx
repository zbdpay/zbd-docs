...
- **[Restrict Client-Side Rewards](/docs/earn/restrict-client-reward-sending)**. Block client SDK reward calls to enforce server-only reward issuance.
- **[Manage API Keys](/docs/earn/manage-api-keys)**. View and revoke API keys to maintain secure backend authentication.
- **[Manage Blocklist Entries](/docs/earn/manage-blocklist-entries)**. Review or remove blocklist entries to adjust client access when needed.
