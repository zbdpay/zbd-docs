...
api: "POST https://api.zbdpay.com/api/v1/rewards/app/{rewardsAppId}/api-version-blocklist"
---
...
- **[Manage Blocklist Entries](/docs/earn/manage-blocklist-entries)** — View or delete existing blocklist entries.
- **[Manage API Keys](/docs/earn/manage-api-keys)** — List, rotate, or revoke API keys to maintain security.
