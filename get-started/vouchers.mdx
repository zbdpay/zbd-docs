...
To create Vouchers, go to the `Vouchers` page in the Dev Dashboard and click `Create Voucher`. When you create a Voucher, it debits the funds from your Developer Wallet. Alternatively, you can use the [Create Voucher](/payments/api/vouchers/create) API endpoint.

## Redeem Voucher

Vouchers are redeemed by entering the unique 8-digit code within the Dev Dashboard or Mobile App, or using the [Redeem Voucher](/payments/api/vouchers/redeem) API endpoint. The funds from the Voucher will be credited to your wallet balance. 
...
2. Navigate to the applicable [Project Wallet](/get-started/project-wallet) page within the [Dev Dashboard](https://dashboard.zebedee.io/) and view the Transactions History table to view a list of your Vouchers created via API.
