...
To create Vouchers, go to the `Vouchers` page in the Developer Dashboard and click `Create Voucher`. When you create a Voucher, it debits the funds from your Developer Wallet. Alternatively, you can use the [Create Voucher](/payments/api/vouchers/create) API endpoint.

## Redeem Voucher

Vouchers are redeemed by entering the unique 8-digit code within the Developer Dashboard or Mobile App, or using the [Redeem Voucher](/payments/api/vouchers/redeem) API endpoint. The funds from the Voucher will be credited to your wallet balance. 

Developer Dashboard users can redeem Vouchers by pressing `z` + `m`, entering the 8-digit code, then pressing `Redeem Voucher`. This will credit the sats to your Developer wallet. 
...
1. Navigate to the `Vouchers` page within the [Developer Dashboard](https://dashboard.zebedee.io/) to view a list of your Vouchers created via the Developer Dashboard UI.

2. Navigate to the applicable [Project Wallet](/get-started/project-wallet) page within the [Developer Dashboard](https://dashboard.zebedee.io/) and view the Transactions History table to view a list of your Vouchers created via API.

3. Use the [Get Voucher](/payments/api/vouchers/retrieve) endpoint to retrieve the details about a Voucher. 

## Revoke a Voucher

If you issue a Voucher, but want to revoke (cancel) it, you can:

1.  Revoke it via the [Revoke Voucher](/payments/api/vouchers/revoke) API endpoint
