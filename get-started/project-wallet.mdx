...
sidebarTitle: 'Understanding wallets'
icon: 'coins'
description: 'Learn how your ZBD Project Wallet works.'
---

The `Wallet` tab available inside of your Project view in the ZBD Developer Dashboard is where you will find all information about movement of money through this Project.
...
- Transfer funds from one Project Wallet to another using the ZBD Developer Dashboard
