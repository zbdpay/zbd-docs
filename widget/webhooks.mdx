...
<Warning>
  The ZBD Widget requires a webhook URL. ZBD sends signed cashout status updates to this endpoint, and Create Session requires `webhook_url`.
</Warning>
