...
The publisher disclosure endpoints can check and record acceptance for all current disclosure types.
...
Most integrations should let the hosted widget collect the user's acceptance. If your integration collects disclosure acceptance before the widget opens, use the publisher disclosure APIs from your server.
