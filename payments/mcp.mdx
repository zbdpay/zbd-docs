...
### Resource `email_payments` (Deprecated):

- `send_email_payments` (`write`): **DEPRECATED** - This endpoint is scheduled for removal by the end of February 2026. Not recommended for new integrations.
