...
api: "POST https://api.zbdpay.com/v0/email/send-payment"
---
...
- Otherwise, the sats will be issued to the email in the form of a valid [ZBD Voucher](/get-started/vouchers) that the recipient can redeem in the [ZBD Mobile App](/earn/app). 
