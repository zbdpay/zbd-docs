...
[zbd.dev](/) documentation pages are content rich and can be a great source of information for LLMs for AI tools. You can use your documentation to fine-tune a chatbot, answer questions about your product, or use it to generate code.
...
<PreviewButton href="https://zbd.dev/llms.txt">Open llms.txt for zbd.dev</PreviewButton>
...
<PreviewButton href="https://zbd.dev/llms-full.txt">Open llms-full.txt for zbd.dev</PreviewButton>
...
<PreviewButton href="https://zbd.dev/get-started.md">Open get-started.md</PreviewButton>
