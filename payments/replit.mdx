...
If you don't yet have a [ZBD Developer Dashboard](https://dashboard.zebedee.io/) account, head on over to the [official how-to documentation](/get-started/create-account) or the [ZBD Developer Dashboard signup page](https://dashboard.zebedee.io/). Once you've got your account setup and verified, create a new Project and fetch its [LIVE API Key](/get-started/sandbox-project) from the dashboard (*important: it HAS to be a LIVE API Key, a SANDBOX API Key will not work*). It should look something like this:
...
The bottom 4 navigation item links take you to other ZBD API and ZBD Developer Dashboard learning resources. Lastly, there are guides on how to best deploy this starter kit to services like Vercel and Replit (this guide!).
