...
<Note>If you're looking for the [Sandbox API](/payments/api/gamertags/send), that's available at `https://sandbox-api.zebedee.io`.</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="See our GitHub Examples" icon="github" color="#000000" href="/payments/templates"></Card>
  <Card title="Learn about ZBD Utility APIs" icon="bolt-lightning" color="#FF9900" href="/payments/api/resources/openapi"></Card>
  <Card title="Download ZBD App" icon="app-store-ios" color="#00ADD8" href="/rewards/app"></Card>
</CardGroup>
