...
<CardGroup cols={2}>
  <Card title="See our GitHub Examples" icon="github" href="/payments/templates"></Card>
  <Card title="View our OpenAPI specification" icon="code" href="/payments/api/resources/openapi"></Card>
</CardGroup>
