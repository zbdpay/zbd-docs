...
<Steps>
  <Step title="Get Your API Keys">
    [Schedule a 15-minute call](https://cal.com/zbdpay/sales) with our team to discuss your use case and get access
  </Step>
...
<CardGroup cols={3}>
  ...
  <Card title="Onramp Integration" icon="circle-dollar" href="/payments/onramp/quickstart">
    Add fiat-to-crypto in your app
  </Card>
  <Card title="Unity Rewards" icon="gamepad" href="/rewards/sdk/integration">
...
<Card title="Get Started Today" icon="calendar" href="https://cal.com/zbdpay/sales">
