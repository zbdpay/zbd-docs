...
`@axobot/pay` is the server half of the L402 protocol. It creates invoice-backed payment challenges and verifies payment proof before allowing access.

<CardGroup cols={2}>
  <Card title="Repository" icon="github" href="https://github.com/zbdpay/agent-pay">
    Full middleware source and adapter tests.
  </Card>
  <Card title="NPM Package" icon="cube" href="https://www.npmjs.com/package/@axobot/pay">
...
```bash
axo fetch "https://api.example.com/protected" --max-sats 100
```
