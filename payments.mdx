...
<Card title="Learn About Onramp" icon="circle-dollar-to-slot" href="/payments/onramp">
...
<Card title="Talk to Sales" icon="comments-dollar" href="https://cal.com/zbdpay/sales">
...
<Steps>
  <Step title="Get Your API Keys">
    [Schedule a call](https://cal.com/zbdpay/sales) with our team to get access
  </Step>
...
<CardGroup cols={3}>
  <Card title="Onramp" icon="circle-dollar-to-slot" href="/payments/onramp">
...
<CardGroup cols={2}>
  <Card title="Sales" icon="phone" href="https://cal.com/zbdpay/sales">
    Get API keys and discuss your use case
  </Card>
  <Card title="Support" icon="headset" href="https://support.zbd.dev">
