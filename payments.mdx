...
<Card title="Talk to Sales" icon="comments-dollar" href="https://cal.com/zbdpay">
...
<Steps>
  <Step title="Get Your API Keys">
    [Schedule a call](https://cal.com/zbdpay) with our team to get access
  </Step>
...
<CardGroup cols={2}>
  <Card title="Sales" icon="phone" href="https://cal.com/zbdpay">
