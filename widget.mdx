...
Before integrating, you should already have a [ZBD Developer Dashboard account](/get-started/create-account) and [project](/get-started/create-project), plus the project API key from the project's [API section](/get-started/api-keys).

<Note>Contact ZBD support to enable the Widget for your project before starting the integration.</Note>

If you are looking for the Widget controls in the Developer Dashboard, open the **Widget** tab on your project. That is where sandbox balance and webhook settings live.
