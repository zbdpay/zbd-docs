...
Before integrating, create a [ZBD Developer Dashboard account](/get-started/create-account), [create a project](/get-started/create-project), and copy your project API key from the project's [API section](/get-started/api-keys).

<Note>Contact ZBD support or your ZBD account team to enable the Widget for your project before starting the integration.</Note>
