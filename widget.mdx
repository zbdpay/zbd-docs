...
For widget ACH cashout, your application must present and record acceptance of
the latest Electronic Funds Transfer disclosure (type `6`). The widget does not
