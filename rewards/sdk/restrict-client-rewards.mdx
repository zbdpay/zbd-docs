...
<Info>
    Optional Step This step is optional but highly recommended for apps with high-value rewards or when you need complete control over reward issuance.
</Info>
...
<ParamField required body="version" type="number">
  ...
  Use <code> 1 </code> to block client SDK calls
</ParamField>
...
| `version` | number | API version that is blocklisted |
...
When a client tries to send rewards after blocklist is applied:
