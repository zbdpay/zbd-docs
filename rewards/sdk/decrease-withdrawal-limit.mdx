...
description: "Programmatically decrease a user's withdrawal limit via the REST API."
api: "POST https://api.zbdpay.com/api/v1/rewards/user/{rewardsUserId}/deduct"
---
...
After decreasing withdrawal limits:

- **[Increase Withdrawal Limit](/rewards/sdk/increase-withdrawal-limit)** - Raise a user's withdrawal limit
