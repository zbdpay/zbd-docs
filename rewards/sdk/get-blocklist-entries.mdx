...
api: "GET https://api.zebedee.io/api/v1/rewards/app/{rewardsAppId}/api-version-blocklist"
---
...
```bash cURL
curl --location 'https://api.zebedee.io/api/v1/rewards/app/b28e0306-2c06-4092-8d56-a1623d6b97fb/api-version-blocklist' \
