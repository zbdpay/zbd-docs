...
The idea here is to use the `transactionId` property returned from the [Pay to ZBD Gamertag](/rewards/api/gamertags/send) response, and use that ID to fetch the latest details of the given Payment.
